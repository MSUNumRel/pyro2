...
import advection_1d.advective_fluxes as flx
...
class Simulation(NullSimulation):
    ...
    def initialize(self):
        ...
        problem = importlib.import_module("advection_1d.problems.{}".format(self.problem_name))
    ...
    def evolve(self):
        ...
        flux_x = flx.unsplit_fluxes(self.cc_data, self.rp, self.dt, "density")
    ...
    def dovis(self):
        ...
        _, axes, cbar_title = plot_tools.setup_axes_1d(myg, 1)
        ...
        ax.plot(myg.x[myg.ng:-(myg.ng)], dens.v())
